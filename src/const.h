...
enum item_t : uint16_t {
	...
	ITEM_SOFT_BOOTS_START = 3549,
	ITEM_SOFT_BOOTS_END = 6529,
	
	ITEM_PRISMATIC_RING_START = 16114,
	ITEM_PRISMATIC_RING_END = 16264,

	ITEM_TROPHY_START = 7369,
	ITEM_TROPHY_END = 7371,
