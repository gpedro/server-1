local config = {
	...
	{chance = {1.54, 9.16}, transformId = 10424, description = "It was made by |PLAYERNAME| and is clearly a little figurine of.. hm, one does not recognise that yet.", achievement = true},
